...
public class NewStudent extends javax.swing.JFrame {
   ...
   Connection con;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_student_male_50px.png"))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "B.Tech", "BCA", "M.Tech", "BSC", "BCom" }));
        ...
        setSize(new java.awt.Dimension(751, 869));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String semester = (String) jComboBox3.getSelectedItem();
        try {
            conn c = new conn();
            String sql = "insert into student values("+sid+",'"+name+"','"+fathername+"','"+course+"','"+branch+"',"+year+","+semester+")";
